...
export default function OrderCompleted({ searchParams }: IParams) {
  return (
    <div id="orderCompleted" className="container mx-auto p-4  max-w-[1180px]  flex flex-col items-center justify-center border-l border-b border-dotted   py-20 relative">
